...
content = content.replace(/purple-400/g, 'zinc-900'); 
content = content.replace(/purple-200/g, 'zinc-200');
content = content.replace(/purple-100/g, 'zinc-100');
...
content = content.replace(/emerald-100/g, 'zinc-100');
...
content = content.replace(/sky-100/g, 'zinc-100');
content = content.replace(/sky-50/g, 'zinc-50');

content = content.replace(/red-500/g, 'rose-500');
content = content.replace(/red-600/g, 'rose-600');

// Gradients remove
content = content.replace(/bg-gradient-to-tr from-zinc-[0-9]+ via-zinc-[0-9]+ to-zinc-[0-9]+/g, 'bg-zinc-900');
content = content.replace(/bg-gradient-to-r from-zinc-[0-9]+ to-zinc-[0-9]+/g, 'bg-zinc-900');
...
content = content.replace(/shadow-md/g, 'shadow-[0_2px_10px_rgb(0,0,0,0.02)]');
